            ...
            <ul class="navbar-nav fw-semibold">
              ...
              <li class="nav-item dropdown offset-lg-1 offset-md-1 offset-6">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a class="dropdown-item" href="/nefrologie">Nefrologie</a>
                  </li>
      ...
      <section id="services" class="services">
        <div class="container">
          <div class="section-title">
            <h2><img src="/img/logorhumatologie.svg" alt=""> Présentation du Service Rhumatologie</h2>
          </div>
<p>Le service de Rhumatologie de médecine interne se spécialise dans le diagnostic et le traitement des maladies articulaires, des troubles musculosquelettiques et des affections auto-immunes affectant les os, les articulations, les muscles et les tissus conjonctifs. Les rhumatologues de médecine interne prennent en charge des pathologies telles que l'arthrite rhumatoïde, l'ostéoporose, la spondylarthrite ankylosante et le lupus érythémateux systémique.</p>
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          ...
          <p>Il est recommandé de consulter un rhumatologue de médecine interne si vous présentez des symptômes tels que :</p>
          <br><br><li> des douleurs articulaires persistantes</li><br>
            <li>une raideur matinale </li><br>
            <li> un gonflement des articulations </li><br>
            <li> des problèmes de mobilité</li><br>
            <li> des douleurs musculaires </li><br>
            <li> une fatigue chronique   </li><br>

            <li> u si vous avez des antécédents familiaux de maladies rhumatismales.</li><br>
          <p> Les personnes atteintes de maladies auto-immunes ou de troubles inflammatoires systémiques peuvent également bénéficier d'une consultation.</p>        
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          ...
          <p>Nos rhumatologues offrent des consultations spécialisées en rhumatologie pour évaluer, diagnostiquer et traiter les maladies articulaires et les troubles musculosquelettiques. Ils réalisent des examens physiques détaillés, commandent des analyses sanguines et des imageries médicales,</p>
      </section>
