    ...
    <div class="big">
      <section id="services" class="services">
        <div class="container">
          <div class="section-title">
            <h2><img src="/img/logodermatologie.svg" alt=""> Présentation du Service Dermatologie</h2>
          </div>
          <p>Le service de Dermatologie de médecine interne se concentre sur le diagnostic, le traitement et la prévention des maladies de la peau, des muqueuses, <br><br>
            des cheveux et des ongles. Les dermatologues de médecine interne sont des experts dans la gestion des affections cutanées telles que l'eczéma, le psoriasis, l'acné, les infections cutanées, les allergies cutanées et les cancers de la peau.</p>
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          ...
          <p>Il est recommandé de consulter un dermatologue de médecine interne si vous présentez des symptômes tels que :</p>
          <br><br><li>des éruptions cutanées persistantes,</li><br>
            <li> des démangeaisons intenses</li><br>
            <li>des plaies qui ne guérissent pas</li><br>
            <li>des changements dans la couleur ou la texture de la peau</li><br>
            <li>des taches ou des lésions suspectes</li><br>
            <li>ou des problèmes capillaires persistants</li><br>
          <p>. Si vous avez des antécédents personnels ou familiaux de maladies de la peau, ou si vous êtes exposé à des facteurs de risque tels que l'exposition excessive au soleil, il est conseillé de consulter un dermatologue.</p>        </div>
      </section>
    
      <section id="services" class="services">
        <div class="container">
          <div class="section-title">
            <h2>Consultations Dermatologiques</h2>
          </div>
<p>Nos dermatologues offrent des consultations spécialisées en dermatologie. Ils effectuent des examens cutanés approfondis, des biopsies de peau si nécessaire, et prescrivent des traitements adaptés à chaque condition dermatologique. Ils traitent les affections inflammatoires de la peau avec des corticoïdes topiques, des immunomodulateurs et des antibiotiques, et proposent des thérapies spécifiques pour les maladies chroniques telles que le psoriasis. De plus, ils effectuent des dépistages réguliers des cancers de la peau et pratiquent des excisions chirurgicales lorsque cela est nécessaire.</p>        </div>
      </section>
