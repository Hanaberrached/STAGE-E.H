      ...
      <section id="services" class="services">
        <div class="container">
          <div class="section-title">
            <h2><img src="/img/logoimmuno.svg" alt=""> Présentation du Service Immuno-allergologie</h2>
          </div>
<p>Le service d'Immunoallergologie de médecine interne se consacre à l'évaluation, au diagnostic et au traitement des maladies allergiques et des troubles du système immunitaire. Les spécialistes en immunoallergologie de médecine interne sont formés pour identifier les allergies alimentaires, les allergies respiratoires, les allergies cutanées, ainsi que les maladies auto-immunes et les déficits immunitaires.</p>
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          ...
          <p>Il est recommandé de consulter un spécialiste en immunoallergologie de médecine interne si vous présentez des symptômes allergiques tels que :</p>
          <br><br> <li>des éruptions cutanées </li><br>
            <li> des démangeaisons</li><br>
            <li> des éternuements fréquents</li><br>
            <li> des yeux rouges et irrités </li><br>
            <li>  des difficultés respiratoires</li><br>
            <li>   ou des réactions anaphylactiques après avoir été exposé à certaines substances. </li><br>
          <p>  Les personnes atteintes de maladies auto-immunes, telles que le lupus ou la polyarthrite rhumatoïde, peuvent également consulter un spécialiste en immunoallergologie pour un suivi et un traitement approprié.</p>        
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          <div class="section-title">
            <h2>Consultations en Immuno-allergologie</h2>
          </div>
          <p>Nos spécialistes en immunoallergologie offrent des consultations spécialisées pour évaluer les allergies et les troubles immunitaires. Ils réalisent des tests d'allergie pour identifier les allergènes spécifiques responsables des réactions allergiques et proposent des plans de gestion personnalisés, incluant des mesures d'éviction, des traitements médicamenteux et, dans certains cas, des désensibilisations. Ils évaluent également les maladies auto-immunes et les déficits immunitaires, et prescrivent des traitements appropriés pour aider à contrôler les symptômes et à améliorer la qualité de vie des patients.</p>
      </section>
