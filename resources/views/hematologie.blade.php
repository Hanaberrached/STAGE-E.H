      ...
      <section id="services" class="services">
        <div class="container">
          <div class="section-title">
            <h2><img src="/img/logohematologie.svg" alt=""> Présentation du Service Hématologie</h2>
          </div>
<p>Le service d'Hématologie de médecine interne se spécialise dans l'étude, le diagnostic et le traitement des maladies du sang et des troubles hématologiques. Les hématologues de médecine interne sont des experts dans la prise en charge des affections telles que les troubles de la coagulation, les anémies, les leucémies, les lymphomes et les troubles de la moelle osseuse.</p>
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          ...
          <p>Il est recommandé de consulter un hématologue de médecine interne si vous présentez des symptômes tels que :</p>
            <li> des saignements anormaux</li><br>
            <li> des douleurs osseuses</li><br>
            <li>des ganglions lymphatiques enflés</li><br>
            <li>Une fatigue excessive</li><br>
            <li> des ecchymoses (des bleus) fréquentes </li><br>
            <li>  des infections récurrentes  </li><br>

            <li>ou des résultats anormaux dans les analyses de sang</li><br>
          <p>Si vous avez des antécédents familiaux de maladies hématologiques ou si vous êtes exposé à des facteurs de risque connus, il est conseillé de consulter un spécialiste en hématologie.</p>        
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          ...
          <p>Nos hématologues offrent des consultations spécialisées en hématologie, visant à évaluer, diagnostiquer et traiter les maladies du sang. Ils réalisent des analyses sanguines approfondies, des tests de coagulation et d'autres examens complémentaires pour déterminer la cause sous-jacente des troubles hématologiques. Les consultations en hématologie comprennent la prescription de médicaments pour traiter les troubles sanguins, la planification de traitements tels que la chimiothérapie ou la radiothérapie pour les cancers hématologiques, ainsi que des suivis réguliers pour surveiller l'évolution de la maladie et ajuster le traitement en conséquence.</p>
      </section>
