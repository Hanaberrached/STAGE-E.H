    ...
    <div class="big">
      <section id="services" class="services">
        <div class="container">
          <div class="section-title">
            <h2><img src="/img/logocardiologie.svg" alt=""> Présentation du Service Cardiologie</h2>
          </div>
          <p>La cardiologie de médecine interne est une spécialité médicale axée sur le diagnostic et le traitement des maladies du cœur et des vaisseaux sanguins chez les adultes.<br><br>
            Les cardiologues de médecine interne se spécialisent dans le traitement de conditions telles que l'hypertension artérielle, les maladies coronariennes, les troubles du rythme cardiaque et l'insuffisance cardiaque.</p>
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          ...
          <p>Vous devriez consulter un cardiologue de médecine interne si vous présentez des symptômes tels que :
            <br><br><li>des douleurs thoraciques</li><br>
            <li>des essoufflements</li><br>
            <li>des palpitations cardiaques</li><br>
            <li>une fatigue excessive</li><br>
            <P>ou si vous avez des antécédents familiaux de maladies cardiaques. Les personnes souffrant de conditions médicales préexistantes, comme le diabète ou l'hypertension, peuvent également bénéficier d'une consultation.</p>
        </div>
      </section>
      ...
      <section id="services" class="services">
        <div class="container">
          <div class="section-title">
            <h2>Consultations cardiologiques</h2>
          </div>
          <p>Nos cardiologues offrent des consultations de cardiologie générale, traitant et suivant des affections telles que l'hypertension artérielle, l'insuffisance cardiaque et les maladies coronariennes. Ils proposent également des consultations de rythmologie pour la prise en charge des troubles du rythme cardiaque et la surveillance des stimulateurs cardiaques.</p>
        </div>
      </section>
